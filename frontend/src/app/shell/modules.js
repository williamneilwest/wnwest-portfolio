import { Blocks, BrainCircuit, Cog, Database, HeartPulse, BookText, Network, UserCircle2, Wrench } from 'lucide-react';
...
export const modules = [
  ...
  { href: '/app/dev/designer', label: 'Dev', summary: 'Prompt-driven app edits', icon: Wrench, readmeHref: '/readme' },
